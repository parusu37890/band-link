...
状態: **追加済み・未実行**。テスト名の `codeUtNNN` は `UT-NNN` に対応します。
...
- IT-013、IT-014、IT-017、IT-020、IT-024、IT-027、IT-028、IT-030
- SEC-010
...
Surefire XML、console log、DB照合を `docs/test-results/<日時>/` に保存します。ここに成功記録は書きません。この文書作成時点では全件NOT_RUNです。
