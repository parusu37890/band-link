...
認証メール再送、SSE会話更新、認証UIの整理を含む最新の全JUnitは、別紙 [LINE Login・認証・会話UIの検証](2026-09-07-line-login-ui.md) に記録した。現在の全件結果は33件成功で、このファイルの11件は初回LINE Login部分だけを実行した時点の履歴である。
