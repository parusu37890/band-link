...
BEGIN
  ...
  SELECT u.id, g.id FROM (VALUES
    ('demo01@bandlink.local','ロック'),('demo01@bandlink.local','ハードロック／メタル'),
    ('demo02@bandlink.local','ロック'),('demo02@bandlink.local','ポップス'),
  ...
  INSERT INTO demo_copy (n, title, body) VALUES
   ...
   (15,'管楽器の方へ。ホーンを入れたファンクをやりたい','リズム隊は固まっています。トランペットかサックスが入ると、狙っている音になります。'),
   ...
   (19,'ヒップホップとバンドの間をやりたい','トラックにギターとドラムを重ねる形を考えています。ジャンルにこだわらない方だと話が早いです。'),
   ...
   (26,'電子音楽寄り。シンセを弾ける方を探しています','生ドラムとシンセを合わせた編成を考えています。機材の話ができる方だと助かります。'),
   (27,'パーカッション募集。リズムを厚くしたい','ドラムはいます。コンガやカホンで色を足してくれる方がいると理想です。'),
   ...
   (39,'その他楽器の方も歓迎。編成は決めていません','バイオリンでもアコーディオンでも、面白ければ何でも。まず話を聞かせてください。'),
   (40,'初心者歓迎。一緒に上手くなっていければ','全員が上手い必要はないと思っています。続けられる人を探しています。');

  UPDATE demo_copy SET part = v.part, genre = v.genre FROM (VALUES
   (1,'ギター','ハードロック／メタル'),(2,'ベース','ロック'),(3,'ドラム','ロック'),(4,'キーボード','ポップス'),
   (5,'ボーカル','ポップス'),(6,'ギター','ブルース'),(7,'その他','フォーク／カントリー'),(8,'ベース','パンク'),
   (9,'管楽器','ジャズ'),(10,'ギター','アニソン／ゲーム音楽'),(11,'ベース','ロック'),(12,'ギター','ハードロック／メタル'),
   (13,'その他','電子音楽'),(14,'ドラム','フォーク／カントリー'),(15,'管楽器','ファンク／ソウル'),(16,'ボーカル','フォーク／カントリー'),
   (17,'その他','ロック'),(18,'弦楽器','クラシック'),(19,'DJ','ヒップホップ'),(20,'ボーカル','ロック'),
   (21,'その他','ポップス'),(22,'ドラム','ポップス'),(23,'ギター','ロック'),(24,'その他','ロック'),
   (25,'ベース','ポップス'),(26,'キーボード','電子音楽'),(27,'パーカッション','ファンク／ソウル'),(28,'その他','ロック'),
   (29,'その他','ポップス'),(30,'ボーカル','ポップス'),(31,'ギター','ロック'),(32,'ベース','R&B'),
   (33,'その他','ロック'),(34,'ドラム','ロック'),(35,'キーボード','ポップス'),(36,'ドラム','ハードロック／メタル'),
   (37,'ギター','ポップス'),(38,'ベース','ロック'),(39,'その他','その他'),(40,'その他','ポップス')
