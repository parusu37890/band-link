...
BEGIN
  ...
  SELECT u.id, p.id FROM (VALUES
    ('demo01@bandlink.local','リードギター'),('demo01@bandlink.local','ボーカル'),
  ...
  UPDATE demo_copy SET part = v.part, genre = v.genre FROM (VALUES
   (1,'リードギター','ハードロック／メタル'),(2,'ベース','邦ロック'),(3,'ドラム','邦ロック'),(4,'キーボード','ポップス'),
   (5,'ボーカル','ポップス'),(6,'リードギター','ブルース'),(7,'ボーカル','フォーク／カントリー'),(8,'ベース','パンク／メロコア'),
   (9,'キーボード','ジャズ'),(10,'リードギター','アニソン'),(11,'ベース','邦ロック'),(12,'リードギター','ハードロック／メタル'),
   (13,'作詞作曲','ボカロ'),(14,'ドラム','フォーク／カントリー'),(15,'キーボード','ファンク／ソウル'),(16,'ボーカル','フォーク／カントリー'),
   (17,'リードギター','洋ロック'),(18,'キーボード','クラシック'),(19,'作詞作曲','R&B'),(20,'ボーカル','邦ロック'),
   (21,'ベース','ポップス'),(22,'ドラム','ポップス'),(23,'リードギター','洋ロック'),(24,'ドラム','邦ロック'),
   (25,'ベース','ポップス'),(26,'キーボード','ポップス'),(27,'ドラム','ファンク／ソウル'),(28,'ベース','洋ロック'),
   (29,'リードギター','ポップス'),(30,'ボーカル','ボカロ'),(31,'リードギター','邦ロック'),(32,'ベース','R&B'),
   (33,'ドラム','洋ロック'),(34,'ドラム','邦ロック'),(35,'キーボード','ポップス'),(36,'ドラム','ハードロック／メタル'),
   (37,'リードギター','アニソン'),(38,'ベース','洋ロック'),(39,'作詞作曲','ポップス'),(40,'キーボード','ポップス')
