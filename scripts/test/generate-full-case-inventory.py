...
features = [
 ...
 ('POST','R-POST-01..08','Recruitment-post',['recruit','join','empty-body','body-boundary','missing-choice','too-many-choice','zero-images','five-images','six-images'],['anonymous','unverified','user','suspended','withdrawn','admin','other-owner'],['posted-0-to-4-weeks','closed','expired','edit-locked','same-type-open','other-type-open'],['list','detail','create','edit','close','republish','delete','double-submit']),
 ('SEARCH','R-SRCH-01..05','Search',['no-filter','single-filter','multi-value-or','cross-field-and','all-filters','no-hit','huge-cursor','invalid-cursor'],['anonymous','user','suspended','withdrawn','admin'],['zero','one','many','tie','history','no-history'],['initial','apply','change','sort','load-more','retry','clear']),
