...
public class MasterDataInitializer implements ApplicationRunner {
    ...
    @Override @Transactional public void run(ApplicationArguments args) {
        add("ボーカル,リードギター,バッキングギター,ベース,ドラム,キーボード,作詞作曲", parts.findAll(), Part::getName, Part::new, parts::save);
        ...
        add("初心者同士で合わせたい,趣味で楽しみたい,趣味でも本格的に取り組みたい,インディーズとして活動したい,プロを目指したい", stances.findAll(), Stance::getName, Stance::new, stances::save);
