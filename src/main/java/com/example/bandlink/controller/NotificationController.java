...
public class NotificationController {
    ...
    @GetMapping("/unread-count") public Map<String,Long> unread(Authentication a,@RequestParam(required=false) String type){
        Long count=type!=null?notifications.countByUserIdAndTypeAndReadAtIsNull(current(a),type):notifications.countByUserIdAndReadAtIsNull(current(a));
