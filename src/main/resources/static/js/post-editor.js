import {api,h,icon,state,main,showPage,notice,button,toast,confirmAction,navigate,frequencies,ages,frequencyLabel,counter,verificationNotice} from './ui.js?v=20260918-2';
